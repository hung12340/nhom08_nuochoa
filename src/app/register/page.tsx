        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start">
            <input
              ...
              onChange={handleChange}
              className="w-4 h-4 text-[#D4AF37] bg-white border-[#D4AF37]/30 rounded focus:ring-[#D4AF37] mt-1"
            />
            <label htmlFor="agreeToTerms" className="ml-2 text-sm text-[#1A1A1A]/70">
              Tôi đồng ý với{' '}
              <span className="text-[#D4AF37] hover:text-[#b8962f] font-semibold">
                điều khoản sử dụng
              </span>
            </label>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#F9F9F9] text-[#1A1A1A]/70">Hoặc đăng ký với</span>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="w-full bg-white border border-[#D4AF37]/30 text-[#1A1A1A] font-medium py-2 px-4 rounded-lg hover:bg-[#F9F9F9] transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
